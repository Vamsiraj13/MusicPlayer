package com.example.vamsismusicplayer.seekbar;
...
public class AudioWaveSeekbar extends View {
    ...
    public AudioWaveSeekbar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs,0);
    }

    public AudioWaveSeekbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
